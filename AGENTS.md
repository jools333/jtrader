...
- **Strategy Statistics & Diagnostics Logging**:
  - `BounceStrategy::diagnose()` scores 11 individual criteria (prior impulse, pullback touch, level held, compression, impulse trigger, entry zone, trend alignment, volume confirmation, momentum exhaustion, wick rejection, R:R).
